namespace De4DotGUI
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnSearchInput.Click += new System.EventHandler(this.BtnSearchInputClick);
			// 
			// btnSearchOutput
			// 
			...
			this.btnSearchOutput.Click += new System.EventHandler(this.BtnSearchOutputClick);
			// 
			// txtOutput
			// 
